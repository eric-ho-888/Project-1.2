...
if search_query:
    ...
    if len(results_df) > 0:
        ...
        display_df = results_df[['categories', 'title', 'positionLevels', 'Entry_Salary_25th', 'Median_Salary', 'minimumYearsExperience', 'Total_Postings']]
        display_df.columns = ['Industry', 'Job Title', 'Seniority', 'Target Entry (25th)', 'Median Market', 'Year of Experiences', 'Total Postings']
